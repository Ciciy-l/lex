...
const DESCRIPTION = [
  ...
  '',
  '参数:',
  '- agent: 可选, codex / claude-code / pi / omp; 不传返四者',
  '',
  '返回值:',
  ...
  '- omp: OMP agent 的可用 model 列表 [{id, label, tier, providers, default_provider_id}]',
