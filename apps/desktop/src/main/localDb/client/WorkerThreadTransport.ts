...
const taskDatabaseFilePrefixes = ${JSON.stringify(TASK_DATABASE_FILE_PREFIXES)};
...
function isTaskDatabaseFileName(name) {
  return taskDatabaseFilePrefixes.some((prefix) =>
    name === prefix + '.db'
