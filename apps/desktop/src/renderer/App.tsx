...
function syncNewMakerPrefs(appDefaultModelRequestId?: string) {
  ...
  // lastByVendor 覆盖 cc/codex/pi/omp，并带上 permissionMode + providerId(worker spawn
  ...
  window.electronAPI.syncNewMakerDraft({
    ...
    lastByVendor: {
      ...
      omp: {
        model: draft.lastByVendor.omp.model,
        effort: draft.lastByVendor.omp.effort,
        permissionMode: draft.lastByVendor.omp.permissionMode,
        providerId: draft.lastByVendor.omp.providerId ?? null,
      },
    },
    modelChosenByVendor: {
      ...
      omp: draft.modelChosenByVendor.omp === true,
    },
