...
//   · omp   = Oh My Pi 官方标记的紫色中段；完整渐变仍由 OMP SVG 标记本身绘制。
...
registerColor('engine-badge-omp', GENERATED_DEFAULTS["engine-badge-omp"], 'OMP 引擎徽标色 — Oh My Pi 官方标记紫色中段(light/dark 同值)');
// Permission selector
...
registerColor('git-graph-lane-1', GENERATED_DEFAULTS["git-graph-lane-1"], 'Git Graph ancestry lane 1; data visualization only');
registerColor('git-graph-lane-2', GENERATED_DEFAULTS["git-graph-lane-2"], 'Git Graph ancestry lane 2; data visualization only');
registerColor('git-graph-lane-3', GENERATED_DEFAULTS["git-graph-lane-3"], 'Git Graph ancestry lane 3; data visualization only');
registerColor('git-graph-lane-4', GENERATED_DEFAULTS["git-graph-lane-4"], 'Git Graph ancestry lane 4; data visualization only');
registerColor('git-graph-lane-5', GENERATED_DEFAULTS["git-graph-lane-5"], 'Git Graph ancestry lane 5; data visualization only');
registerColor('git-graph-lane-6', GENERATED_DEFAULTS["git-graph-lane-6"], 'Git Graph ancestry lane 6; data visualization only');
