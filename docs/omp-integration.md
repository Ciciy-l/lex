...
这两个模块尚未从公共 index 导出，也没有生产消费者。没有引擎注册、GUI、启动器、
权限桥、持久化、SSH、Mobile、Device Link 或 Orca 接线，不能宣称“已支持 OMP”。
...
这仍是开发模式、零 prompt 的内部协议探测准备，不是 OMP 产品支持：没有真实项目执行、
