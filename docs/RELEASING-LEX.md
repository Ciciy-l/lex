...
`CINDY-SYNC-20260905.md`, `CINDY-SYNC-20260910.md`, and
`CINDY-SYNC-20260911.md` remain historical records for earlier snapshots and
their separately recorded identity findings; those findings must not be reused
as a count or conclusion for the `v0.1.86` range.
